    ...
    return <>
        <div className='relative'>
            <section id="properties-hero-section" className="properties-hero-section  px-4 md:px-10 lg:px-20 py-[50px] md:py-[75px] lg:pt-[100px] 2xl:pt-[150px] lg:pb-[130px] 2xl:pb-40 lg:mb-[193px] border-b border-b-[#262626]">
                ...
                <p className="text-sm text-[#999999] lg:text-base 2xl:text-lg  lg:w-[80%]">
            ...
            <section id="search-properties-section" className="max-lg:mt-10 max-lg:mb-[60px] px-4 lg:z-20 lg:absolute lg:flex lg:flex-col top-[85%] w-full text-sm">
